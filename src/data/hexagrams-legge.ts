...
// Translation: James Legge, 1899 (public domain)
// lines[]: 6 values bottom→top. 1=yang (solid), 0=yin (broken)

export interface HexagramLegge {
  number: number;
  name: string;
  chinese: string;
...
export const HEXAGRAMS: Record<number, HexagramLegge> = {
  1: {
    number: 1,
  ...
  6: {
    ...
    lineTexts: [
      ...
      "To nourish oneself on ancient virtue induces perseverance. Danger, but good fortune in the end. If by chance you are in the service of a king, seek not works.",
  ...
  12: {
    ...
    lineTexts: [
      ...
      "They bear and endure; this means good fortune for inferior men. The standstill serves to help the great man to attain success.",
      "They bear shame.",
  ...
  15: {
    ...
    lineTexts: [
      ...
      "A superior man of merit, modest to the end. Good fortune.",
  ...
  21: {
    ...
    lineTexts: [
      ...
      "Bites on dried lean meat. Receives yellow gold. Perseveringly conscious of danger. No blame.",
  ...
  24: {
    ...
    image:
      "Thunder within the earth: the image of the Turning Point. Thus the kings of antiquity closed the passes at the time of solstice. Merchants and strangers did not travel, and the ruler did not journey through the provinces.",
    lineTexts: [
  ...
  33: {
    ...
    image:
      "Mountain under heaven: the image of Retreat. Thus the superior man keeps the inferior man at a distance, not angrily but with dignity.",
    lineTexts: [
  ...
  34: {
    ...
    lineTexts: [
      ...
      "A he-goat butts against a hedge. He cannot go backward, he cannot go forward. Nothing serves to further. If one notes the difficulty, this brings good fortune.",
    ],
  },
  35: {
    number: 35,
  ...
  38: {
    ...
    lineTexts: [
      ...
      "One sees the wagon retarded, the oxen halted, a man's hair and nose cut off. Not a good beginning, but a good end.",
  ...
  43: {
    number: 43,
    name: "Kuai / Breakthrough (Resoluteness)",
    chinese: "夬",
    trigrams: { upper: "Lake", lower: "Heaven" },
    lines: [1, 1, 1, 1, 1, 0],
    judgment:
      "Breakthrough. One must resolutely make the matter known at the court of the king. It must be announced truthfully. Danger. It is necessary to notify one's own city. It does not further one to resort to arms. It furthers one to undertake something.",
    image:
  ...
  46: {
    ...
    lineTexts: [
      ...
      "Pushing upward in the dark. It furthers one to be unremittingly persevering.",
    ],
  },
  47: {
    number: 47,
  ...
  51: {
    number: 51,
    name: "Chen / The Arousing (Thunder)",
    chinese: "震",
    trigrams: { upper: "Thunder", lower: "Thunder" },
    lines: [1, 0, 0, 1, 0, 0],
    judgment:
      "The Arousing. Success. Shock comes — oh, oh! Laughing words — ha, ha! The shock terrifies for a hundred miles, and he does not let fall the sacrificial spoon and chalice.",
    image:
  ...
  62: {
    ...
    lineTexts: [
      ...
      "He passes him by, not meeting him. The flying bird leaves him behind. Misfortune. This means bad luck and injury.",
    ],
  },
  63: {
    number: 63,
    ...
    lineTexts: [
      ...
      "Gets his head in the water. Danger.",
    ],
  },
  64: {
    number: 64,
...
// Index by binary-string key: lines joined bottom→top, yang=1, yin=0.
// Matches the demo's hexagramKey() convention so casts look up directly.
const BY_BINARY: Map<string, HexagramLegge> = new Map(
  Object.values(HEXAGRAMS).map((h) => [h.lines.join(""), h]),
);

export function hexagramByBinary(key: string): HexagramLegge | undefined {
  return BY_BINARY.get(key);
}
