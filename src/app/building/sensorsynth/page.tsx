...
export const metadata = {
  title: "SensorSynthFM | James Dishman",
  description:
      ...
      <main className="container">
        ...
        <section className={styles.section}>
          ...
          <p className={styles.body}>
            ...
            The interface is a boundary. SensorSynthFM starts from a different premise: what if
          ...
          <p className={styles.body}>
            SensorSynthFM is an iPad FM synthesizer that treats every available device sensor as
        ...
        <section className={`${styles.section} ${styles.sectionHighlight}`}>
          ...
          <p className={styles.body}>
            Read it here: <a href="/writing/sensorsynth-needed-a-wiki">Why SensorSynthFM Needed a Wiki Before It Needed More Features</a>.
          </p>
          <p className={styles.body}>
