    ...
    <div className={styles.page}>
      <main className="container">
        ...
        <section className={styles.section}>
          ...
          <p className={styles.body}>
            I&apos;ve been making electronic music for thirty years and working with Ableton, as a user, community organizer, and advocate, for over a decade. I lead the Pittsburgh Ableton User
        ...
        <section className={styles.section}>
          ...
          <p className={styles.body}>
            ...
            navigation attempt, testing what happens when a user tries to find a specific sound without working
        ...
        <section className={styles.section}>
          ...
          <div className={styles.finding}>
            ...
            <p className={styles.body}>
              When a user commits to the linear path, starting from the beginning and working through each module in sequence, Learning Synths works well. Buttons are consistent and follow standard
          ...
          <div className={styles.finding}>
            ...
            <p className={styles.body}>
              ...
              then must correctly associate "Envelopes: CHANGE OVER TIME," a technical label using undefined vocabulary, with the legato quality they&apos;re trying to achieve. At each step, this is a
        ...
        <section className={`${styles.section} ${styles.sectionHighlight}`}>
          ...
          <p className={styles.body}>
            ...
            who arrives with a goal and tries to navigate toward it (which describes most beginners in domains they care about) hits a wall that the site&apos;s content quality can&apos;t compensate for.
          </p>
          <p className={styles.body}>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.reflectionList}>
            <li>
              ...
              accessible. It tells the novice user whether this is the module they need.
            </li>
            <li>
        ...
        <section className={`${styles.section} ${styles.sectionHighlight}`}>
          ...
          <p className={styles.body}>
            This cognitive walkthrough is part of a three-study series applying different inspection methods
        ...
        <section className={styles.section}>
          ...
          <p className={styles.body}>
            <a href="/pdfs/ableton-learning-synths-cognitive-walkthrough.pdf" target="_blank" rel="noopener noreferrer">View original PDF →</a>
          </p>
        </section>
